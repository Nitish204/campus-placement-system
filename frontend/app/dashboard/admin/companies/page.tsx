...
export default function AdminCompaniesPage() {
  ...
  return (
    <DashboardShell
      ...
      nav={
        <>
          ...
          <NavTab href="/dashboard/admin/companies" active>Companies</NavTab>
    ...
    >
      <h1 className="font-display font-bold text-xl text-ink mb-6">All companies ({companies.length})</h1>
